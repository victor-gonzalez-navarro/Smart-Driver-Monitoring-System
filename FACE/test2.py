...
predictor = dlib.shape_predictor("/Users/Victor/Dektop/SDMS/FACE/shape_predictor_68_face_landmarks.dat")  # Or set this to whatever you named the downloaded file
clf = joblib.load("/Users/Victor/Dektop/SDMS/FACE/Filenames2/filenameNew.pkl")

test_data = []



image = cv2.imread("imagenTest.pgm")
...
pca = joblib.load("/Users/Victor/Dektop/SDMS/FACE/pca.pkl")
